...
void UTIL_createButtonsPanel()
{
	...
	if(g_clientVersion >= 1220)
	{
		...
		newRadioIcon->startEvents();
		newWindow->addChild(newRadioIcon);
		newRadioIcon = new GUI_RadioIcon(iRect(52, 25, GUI_UI_ICON_PARTYLIST_UP_W, GUI_UI_ICON_PARTYLIST_UP_H), GUI_UI_IMAGE, GUI_UI_ICON_PARTYLIST_UP_X, GUI_UI_ICON_PARTYLIST_UP_Y, GUI_UI_ICON_PARTYLIST_DOWN_X, GUI_UI_ICON_PARTYLIST_DOWN_Y, 0, BUTTONS_PARTY_DESCRIPTION1);
	...
	else if(g_clientVersion >= 1132)
	{
		...
		newRadioIcon->startEvents();
		newWindow->addChild(newRadioIcon);
		newRadioIcon = new GUI_RadioIcon(iRect(41, 25, GUI_UI_ICON_UNJUSTIFIED_UP_W, GUI_UI_ICON_UNJUSTIFIED_UP_H), GUI_UI_IMAGE, GUI_UI_ICON_UNJUSTIFIED_UP_X, GUI_UI_ICON_UNJUSTIFIED_UP_Y, GUI_UI_ICON_UNJUSTIFIED_DOWN_X, GUI_UI_ICON_UNJUSTIFIED_DOWN_Y, 0, BUTTONS_UNJUSTIFIED_DESCRIPTION1);
		newRadioIcon->setRadioEventCallback(&CheckUnjustifiedWindowOpen, BUTTONS_UNJUSTIFIED_DESCRIPTION2);
		newRadioIcon->setButtonEventCallback(&buttons_Events, BUTTONS_UNJUSTIFIED_EVENTID);
		newRadioIcon->startEvents();
		newWindow->addChild(newRadioIcon);
