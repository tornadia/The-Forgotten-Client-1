...
#define MAIN_WINDOW_ENTERGAME_BUTTON_W 86
#define MAIN_WINDOW_ENTERGAME_BUTTON_H 20
...
#define MAIN_WINDOW_PROTOCOL_BUTTON_W 86
#define MAIN_WINDOW_PROTOCOL_BUTTON_H 20
...
#define MAIN_WINDOW_ACCESSACC_BUTTON_Y 75
#define MAIN_WINDOW_ACCESSACC_BUTTON_W 86
#define MAIN_WINDOW_ACCESSACC_BUTTON_H 20
#define MAIN_WINDOW_ACCESSACC_EVENTID 1002
#define MAIN_WINDOW_OPTIONS_BUTTON_TEXT "Options"
#define MAIN_WINDOW_OPTIONS_BUTTON_X 15
#define MAIN_WINDOW_OPTIONS_BUTTON_Y 105
#define MAIN_WINDOW_OPTIONS_BUTTON_W 86
#define MAIN_WINDOW_OPTIONS_BUTTON_H 20
#define MAIN_WINDOW_OPTIONS_EVENTID 1003
#define MAIN_WINDOW_INFO_BUTTON_TEXT "Info"
#define MAIN_WINDOW_INFO_BUTTON_X 15
#define MAIN_WINDOW_INFO_BUTTON_Y 135
#define MAIN_WINDOW_INFO_BUTTON_W 86
#define MAIN_WINDOW_INFO_BUTTON_H 20
#define MAIN_WINDOW_INFO_EVENTID 1004
#define MAIN_WINDOW_EXITGAME_BUTTON_TEXT "Exit Game"
#define MAIN_WINDOW_EXITGAME_BUTTON_X 15
#define MAIN_WINDOW_EXITGAME_BUTTON_Y 165
#define MAIN_WINDOW_EXITGAME_BUTTON_W 86
#define MAIN_WINDOW_EXITGAME_BUTTON_H 20
#define MAIN_WINDOW_EXITGAME_EVENTID 1005
...
void mainWindow_Events(Uint32 event, Sint32)
{
	switch(event)
	{
		case MAIN_WINDOW_ENTERGAME_EVENTID:
			UTIL_createEnterGame();
			break;
		case MAIN_WINDOW_PROTOCOL_EVENTID:
			UTIL_protocolOptions();
			break;
		case MAIN_WINDOW_ACCESSACC_EVENTID:
			UTIL_OpenURL(MAIN_WINDOW_ACCESSACC_BUTTON_LINK);
			break;
		case MAIN_WINDOW_OPTIONS_EVENTID:
			UTIL_options();
			break;
		case MAIN_WINDOW_INFO_EVENTID:
			UTIL_info();
			break;
