...
void UTIL_deathWindow(Uint8 deathType, Uint8 penalty)
{
	...
	switch(type)
	{
		case 1:
		{
			...
			newWindow->addChild(newLabel);
			GUI_Button* newButton = new GUI_Button(iRect(DEATH_NOTIFICATION_WIDTH_UNFAIR-56, DEATH_NOTIFICATION_HEIGHT_UNFAIR-30, 43, 20), "Cancel", CLIENT_GUI_ESCAPE_TRIGGER);
			newButton->setButtonEventCallback(&death_notification_Events, DEATH_NOTIFICATION_CANCEL_EVENTID);
			newButton->startEvents();
			newWindow->addChild(newButton);
			newButton = new GUI_Button(iRect(DEATH_NOTIFICATION_WIDTH_UNFAIR-109, DEATH_NOTIFICATION_HEIGHT_UNFAIR-30, 43, 20), "Ok", CLIENT_GUI_ENTER_TRIGGER);
		...
		case 2:
		{
			...
			newWindow->addChild(newLabel);
			GUI_Button* newButton = new GUI_Button(iRect(DEATH_NOTIFICATION_WIDTH_BLESSED-56, DEATH_NOTIFICATION_HEIGHT_BLESSED-30, 43, 20), "Cancel", CLIENT_GUI_ESCAPE_TRIGGER);
			newButton->setButtonEventCallback(&death_notification_Events, DEATH_NOTIFICATION_CANCEL_EVENTID);
			newButton->startEvents();
			newWindow->addChild(newButton);
			newButton = new GUI_Button(iRect(DEATH_NOTIFICATION_WIDTH_BLESSED-109, DEATH_NOTIFICATION_HEIGHT_BLESSED-30, 43, 20), "Ok", CLIENT_GUI_ENTER_TRIGGER);
			newButton->setButtonEventCallback(&death_notification_Events, DEATH_NOTIFICATION_OK_EVENTID);
			newButton->startEvents();
			newWindow->addChild(newButton);
		...
		default:
		{
			...
			newWindow->addChild(newLabel);
			GUI_Button* newButton = new GUI_Button(iRect(DEATH_NOTIFICATION_WIDTH_REGULAR-56, DEATH_NOTIFICATION_HEIGHT_REGULAR-30, 43, 20), "Cancel", CLIENT_GUI_ESCAPE_TRIGGER);
			newButton->setButtonEventCallback(&death_notification_Events, DEATH_NOTIFICATION_CANCEL_EVENTID);
			newButton->startEvents();
			newWindow->addChild(newButton);
			newButton = new GUI_Button(iRect(DEATH_NOTIFICATION_WIDTH_REGULAR-109, DEATH_NOTIFICATION_HEIGHT_REGULAR-30, 43, 20), "Ok", CLIENT_GUI_ENTER_TRIGGER);
			newButton->setButtonEventCallback(&death_notification_Events, DEATH_NOTIFICATION_OK_EVENTID);
			newButton->startEvents();
			newWindow->addChild(newButton);
