...
DistanceEffect::DistanceEffect(const Position& from, const Position& to, ThingType* type)
{
	m_thingType = type;
	m_fromPosition = from;
	m_toPosition = to;
...
DistanceEffect* DistanceEffect::createDistanceEffect(const Position& pos, const Position& to, Uint16 type)
{
	...
	if(ttype)
	{
		...
		if(width == 1 && height == 1)
		{
			DistanceEffect1X1* newDistanceEffectX = new DistanceEffect1X1(pos, to, ttype);
		...
		{
			DistanceEffect2X1* newDistanceEffectX = new DistanceEffect2X1(pos, to, ttype);
			newDistanceEffectX->m_1X1Sprites = ttype->getSprite(ThingFrameGroup_Default, 0, 0, 0, newDistanceEffectX->m_xPattern, newDistanceEffectX->m_yPattern, 0, 0);
		...
		{
			DistanceEffect1X2* newDistanceEffectX = new DistanceEffect1X2(pos, to, ttype);
			newDistanceEffectX->m_1X1Sprites = ttype->getSprite(ThingFrameGroup_Default, 0, 0, 0, newDistanceEffectX->m_xPattern, newDistanceEffectX->m_yPattern, 0, 0);
		...
		{
			DistanceEffect2X2* newDistanceEffectX = new DistanceEffect2X2(pos, to, ttype);
			newDistanceEffectX->m_1X1Sprites = ttype->getSprite(ThingFrameGroup_Default, 0, 0, 0, newDistanceEffectX->m_xPattern, newDistanceEffectX->m_yPattern, 0, 0);
			newDistanceEffectX->m_2X1Sprites = ttype->getSprite(ThingFrameGroup_Default, 1, 0, 0, newDistanceEffectX->m_xPattern, newDistanceEffectX->m_yPattern, 0, 0);
			newDistanceEffectX->m_1X2Sprites = ttype->getSprite(ThingFrameGroup_Default, 0, 1, 0, newDistanceEffectX->m_xPattern, newDistanceEffectX->m_yPattern, 0, 0);
		...
		if(!newDistanceEffect)
			newDistanceEffect = new DistanceEffect(pos, to, ttype);
	}
	else
		newDistanceEffect = new DistanceEffectNULL(pos, to, ttype);
...
DistanceEffectNULL::DistanceEffectNULL(const Position& pos, const Position& to, ThingType* type) : DistanceEffect(pos, to, type) {;}
void DistanceEffectNULL::render(Sint32, Sint32) {;}

DistanceEffect1X1::DistanceEffect1X1(const Position& pos, const Position& to, ThingType* type) : DistanceEffect(pos, to, type)
{
	m_1X1Sprites = 0;
}
...
DistanceEffect2X1::DistanceEffect2X1(const Position& pos, const Position& to, ThingType* type) : DistanceEffect(pos, to, type)
{
	m_1X1Sprites = 0;
	m_2X1Sprites = 0;
}
...
DistanceEffect1X2::DistanceEffect1X2(const Position& pos, const Position& to, ThingType* type) : DistanceEffect(pos, to, type)
{
	m_1X1Sprites = 0;
	m_1X2Sprites = 0;
}
...
DistanceEffect2X2::DistanceEffect2X2(const Position& pos, const Position& to, ThingType* type) : DistanceEffect(pos, to, type)
{
	m_1X1Sprites = 0;
	m_1X2Sprites = 0;
	m_1X2Sprites = 0;
