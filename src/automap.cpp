...
void AutomapArea::renderMarks(Sint32 zoom, Sint32 diff, Sint32 x, Sint32 y, Sint32 x1, Sint32 y1, Sint32 x2, Sint32 y2)
{
	...
	for(std::vector<MapMark>::iterator it = m_marks.begin(), end = m_marks.end(); it != end; ++it)
	{
		...
		if(mark.x >= x1 && mark.x <= x2 && mark.y >= y1 && mark.y <= y2)
		{
			...
			switch(mark.type)
			{
				case MAPMARK_TICK: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_TICK_X, GUI_UI_ICON_MINIMAP_MARK_TICK_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_TICK_W, GUI_UI_ICON_MINIMAP_MARK_TICK_H); break;
				case MAPMARK_QUESTION: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_QUESTION_X, GUI_UI_ICON_MINIMAP_MARK_QUESTION_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_QUESTION_W, GUI_UI_ICON_MINIMAP_MARK_QUESTION_H); break;
				case MAPMARK_EXCLAMATION: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_EXCLAMATION_X, GUI_UI_ICON_MINIMAP_MARK_EXCLAMATION_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_EXCLAMATION_W, GUI_UI_ICON_MINIMAP_MARK_EXCLAMATION_H); break;
				case MAPMARK_STAR: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_STAR_X, GUI_UI_ICON_MINIMAP_MARK_STAR_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_STAR_W, GUI_UI_ICON_MINIMAP_MARK_STAR_H); break;
				case MAPMARK_CROSS: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_CROSS_X, GUI_UI_ICON_MINIMAP_MARK_CROSS_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_CROSS_W, GUI_UI_ICON_MINIMAP_MARK_CROSS_H); break;
				case MAPMARK_TEMPLE: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_TEMPLE_X, GUI_UI_ICON_MINIMAP_MARK_TEMPLE_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_TEMPLE_W, GUI_UI_ICON_MINIMAP_MARK_TEMPLE_H); break;
				case MAPMARK_KISS: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_KISS_X, GUI_UI_ICON_MINIMAP_MARK_KISS_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_KISS_W, GUI_UI_ICON_MINIMAP_MARK_KISS_H); break;
				case MAPMARK_REDNORTH: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_REDNORTH_X, GUI_UI_ICON_MINIMAP_MARK_REDNORTH_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_REDNORTH_W, GUI_UI_ICON_MINIMAP_MARK_REDNORTH_H); break;
				case MAPMARK_REDEAST: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_REDEAST_W, GUI_UI_ICON_MINIMAP_MARK_REDEAST_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_REDEAST_W, GUI_UI_ICON_MINIMAP_MARK_REDEAST_H); break;
				case MAPMARK_GREENNORTH: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_GREENNORTH_X, GUI_UI_ICON_MINIMAP_MARK_GREENNORTH_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_GREENNORTH_W, GUI_UI_ICON_MINIMAP_MARK_GREENNORTH_H); break;
				case MAPMARK_SHOVEL: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_SHOVEL_X, GUI_UI_ICON_MINIMAP_MARK_SHOVEL_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_SHOVEL_W, GUI_UI_ICON_MINIMAP_MARK_SHOVEL_H); break;
				case MAPMARK_SWORD: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_SWORD_X, GUI_UI_ICON_MINIMAP_MARK_SWORD_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_SWORD_W, GUI_UI_ICON_MINIMAP_MARK_SWORD_H); break;
				case MAPMARK_FLAG: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_FLAG_X, GUI_UI_ICON_MINIMAP_MARK_FLAG_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_FLAG_W, GUI_UI_ICON_MINIMAP_MARK_FLAG_H); break;
				case MAPMARK_LOCK: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_LOCK_X, GUI_UI_ICON_MINIMAP_MARK_LOCK_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_LOCK_W, GUI_UI_ICON_MINIMAP_MARK_LOCK_H); break;
				case MAPMARK_BAG: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_BAG_X, GUI_UI_ICON_MINIMAP_MARK_BAG_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_BAG_W, GUI_UI_ICON_MINIMAP_MARK_BAG_H); break;
				case MAPMARK_SKULL: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_SKULL_X, GUI_UI_ICON_MINIMAP_MARK_SKULL_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_SKULL_W, GUI_UI_ICON_MINIMAP_MARK_SKULL_H); break;
				case MAPMARK_DOLLAR: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_DOLLAR_X, GUI_UI_ICON_MINIMAP_MARK_DOLLAR_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_DOLLAR_W, GUI_UI_ICON_MINIMAP_MARK_DOLLAR_H); break;
				case MAPMARK_REDSOUTH: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_REDSOUTH_X, GUI_UI_ICON_MINIMAP_MARK_REDSOUTH_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_REDSOUTH_W, GUI_UI_ICON_MINIMAP_MARK_REDSOUTH_H); break;
				case MAPMARK_REDWEST: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_REDWEST_X, GUI_UI_ICON_MINIMAP_MARK_REDWEST_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_REDWEST_W, GUI_UI_ICON_MINIMAP_MARK_REDWEST_H); break;
				case MAPMARK_GREENSOUTH: renderer->drawPicture(GUI_UI_IMAGE, GUI_UI_ICON_MINIMAP_MARK_GREENSOUTH_X, GUI_UI_ICON_MINIMAP_MARK_GREENSOUTH_Y, posX, posY, GUI_UI_ICON_MINIMAP_MARK_GREENSOUTH_W, GUI_UI_ICON_MINIMAP_MARK_GREENSOUTH_H); break;
			}
		}
	}
}
